...
由于
$$ \mathcal{N}(\boldsymbol{x}|0,I_{D})=\frac1{(2\pi)^{D/2}} \exp\left[-\frac{\boldsymbol{x}^{\mathsf{T}}\boldsymbol{x}}{2}\right] = \prod_{i=1}^D\frac1{(2\pi)^{1/2}} \exp\left[-\frac{\boldsymbol{x}^{\mathsf{T}}\boldsymbol{x}}{2}\right] $$
