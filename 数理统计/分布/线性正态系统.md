...
故
$$ \int\mathcal{N}(\boldsymbol{x}|\boldsymbol{\mu}_x,\boldsymbol{\Sigma}_x)\mathcal{N}(\boldsymbol{y}|\mathbf{Wx}+\boldsymbol{b},\boldsymbol{\Sigma}_y)d\boldsymbol{z}=\mathcal{N}(\boldsymbol{y}|\mathbf{W}\boldsymbol{\mu}_x+\boldsymbol{b},\boldsymbol{\Sigma}_y+\mathbf{W}\boldsymbol{\Sigma}_x\mathbf{W}^\mathsf{T}) $$
